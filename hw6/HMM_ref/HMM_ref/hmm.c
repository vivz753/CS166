...
// begins with rand (approximately uniform) A, B and pi,
...
oops:   fprintf(stderr, "\nUsage: %s filename startPos startChar maxChars maxIters seed\n\n", argv[0]);
        ...
        fprintf(stderr, "      seed == seed value for pseudo-rand number generator (PRNG)\n\n");
                  ...
                  int seed)
{
    ...
    // initialize pseudo-rand number generator
    srand(seed);
